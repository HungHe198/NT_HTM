...
{
    /// <inheritdoc />
    public partial class hung131t : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollapsedLength = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Weight = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TipWeight = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ButtWeight = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TipDiameter = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TopDiameter = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ButtDiameter = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BalancePoint = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BalanceLoadPoint = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BalanceLoadDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RecommendedLine = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RecommendedFishWeight = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HandleType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    JointType = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("c5c75f33-e6f6-4d30-be42-a74670497dda"), "NT Fishing", "https://ntfishing.example" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-aaaa-bbbb-cccc-111111111111"), "WELCOME10", 10m, new DateTime(2026, 1, 23, 12, 28, 57, 281, DateTimeKind.Local).AddTicks(7312), 50000m, 1000, 300000m, new DateTime(2025, 12, 16, 12, 28, 57, 281, DateTimeKind.Local).AddTicks(7294) },
                    { new Guid("22222222-aaaa-bbbb-cccc-222222222222"), "SAVE15", 15m, new DateTime(2026, 2, 23, 12, 28, 57, 281, DateTimeKind.Local).AddTicks(7319), 100000m, 500, 500000m, new DateTime(2025, 12, 20, 12, 28, 57, 281, DateTimeKind.Local).AddTicks(7319) },
                    { new Guid("33333333-aaaa-bbbb-cccc-333333333333"), "BIGSALE25", 25m, new DateTime(2026, 3, 23, 12, 28, 57, 281, DateTimeKind.Local).AddTicks(7323), 200000m, 300, 800000m, new DateTime(2025, 12, 22, 12, 28, 57, 281, DateTimeKind.Local).AddTicks(7323) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000001"), new Guid("c5c75f33-e6f6-4d30-be42-a74670497dda"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3142), null, "Cần câu đài mẫu 1", "CD001", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000002"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3151), null, "Cần câu đài mẫu 2", "CD002", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000003"), new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3160), null, "Cần câu đài mẫu 3", "CD003", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000004"), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3167), null, "Cần câu đài mẫu 4", "CD004", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000005"), new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3171), null, "Cần câu đài mẫu 5", "CD005", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000006"), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3176), null, "Cần câu đài mẫu 6", "CD006", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000007"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3180), null, "Cần câu đài mẫu 7", "CD007", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000008"), new Guid("c5c75f33-e6f6-4d30-be42-a74670497dda"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3184), null, "Cần câu đài mẫu 8", "CD008", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000009"), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3188), null, "Cần câu đài mẫu 9", "CD009", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000010"), new Guid("c5c75f33-e6f6-4d30-be42-a74670497dda"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3194), null, "Cần câu đài mẫu 10", "CD010", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000011"), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3198), null, "Cần câu đài mẫu 11", "CD011", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000012"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3204), null, "Cần câu đài mẫu 12", "CD012", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000013"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3208), null, "Cần câu đài mẫu 13", "CD013", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000014"), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3212), null, "Cần câu đài mẫu 14", "CD014", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000015"), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3215), null, "Cần câu đài mẫu 15", "CD015", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000016"), new Guid("c5c75f33-e6f6-4d30-be42-a74670497dda"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3219), null, "Cần câu đài mẫu 16", "CD016", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000017"), new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3223), null, "Cần câu đài mẫu 17", "CD017", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000018"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3228), null, "Cần câu đài mẫu 18", "CD018", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000019"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3241), null, "Cần câu đài mẫu 19", "CD019", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000020"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3247), null, "Cần câu đài mẫu 20", "CD020", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000021"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3251), null, "Cần câu đài mẫu 21", "CD021", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000022"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3255), null, "Cần câu đài mẫu 22", "CD022", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000023"), new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3259), null, "Cần câu đài mẫu 23", "CD023", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000024"), new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3263), null, "Cần câu đài mẫu 24", "CD024", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000025"), new Guid("c5c75f33-e6f6-4d30-be42-a74670497dda"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3266), null, "Cần câu đài mẫu 25", "CD025", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000026"), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3270), null, "Cần câu đài mẫu 26", "CD026", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000027"), new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3274), null, "Cần câu đài mẫu 27", "CD027", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000028"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3281), null, "Cần câu đài mẫu 28", "CD028", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000029"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3285), null, "Cần câu đài mẫu 29", "CD029", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000030"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3288), null, "Cần câu đài mẫu 30", "CD030", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000031"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3292), null, "Cần câu đài mẫu 31", "CD031", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000032"), new Guid("c5c75f33-e6f6-4d30-be42-a74670497dda"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3296), null, "Cần câu đài mẫu 32", "CD032", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000033"), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3300), null, "Cần câu đài mẫu 33", "CD033", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000034"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3305), null, "Cần câu đài mẫu 34", "CD034", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000035"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3314), null, "Cần câu đài mẫu 35", "CD035", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000036"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3321), null, "Cần câu đài mẫu 36", "CD036", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000037"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3325), null, "Cần câu đài mẫu 37", "CD037", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000038"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3329), null, "Cần câu đài mẫu 38", "CD038", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000039"), new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3333), null, "Cần câu đài mẫu 39", "CD039", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000040"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3337), null, "Cần câu đài mẫu 40", "CD040", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000041"), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3341), null, "Cần câu đài mẫu 41", "CD041", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000042"), new Guid("c5c75f33-e6f6-4d30-be42-a74670497dda"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3345), null, "Cần câu đài mẫu 42", "CD042", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000043"), new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3349), null, "Cần câu đài mẫu 43", "CD043", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000044"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3355), null, "Cần câu đài mẫu 44", "CD044", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000045"), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3358), null, "Cần câu đài mẫu 45", "CD045", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000046"), new Guid("c5c75f33-e6f6-4d30-be42-a74670497dda"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3363), null, "Cần câu đài mẫu 46", "CD046", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000047"), new Guid("c5c75f33-e6f6-4d30-be42-a74670497dda"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3366), null, "Cần câu đài mẫu 47", "CD047", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000048"), new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3370), null, "Cần câu đài mẫu 48", "CD048", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000049"), new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3374), null, "Cần câu đài mẫu 49", "CD049", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null },
                    { new Guid("00000000-0000-0000-0000-000000000050"), new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), null, new DateTime(2025, 12, 23, 5, 28, 57, 226, DateTimeKind.Utc).AddTicks(3378), null, "Cần câu đài mẫu 50", "CD050", null, null, "Cần câu đài chất lượng, phù hợp hỗ dịch vụ và tự nhiên", "1", "/images/product-placeholder.png", null, null }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "Email", "Fullname", "PasswordHash", "PhoneNumber", "RoleId", "Status", "Username" },
                values: new object[] { new Guid("11111111-2222-3333-4444-555555555555"), "admin@example.com", "System Administrator", "AQAAAAIAAYagAAAAENpOeJcROQ19c7dTbRmD9q4pRBXNhW0hRCP0CJLW3Edp/FlFI9rsowWvcSW1Pk6WNg==", null, new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), "Active", "admin" });
