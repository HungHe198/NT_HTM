...
namespace NT.WEB.Controllers
{
    ...
    {
        private readonly LengthWebService _service;

        public LengthController(LengthWebService service)
        {
        ...
        public async Task<IActionResult> Create(Length model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, Length model)
        {
