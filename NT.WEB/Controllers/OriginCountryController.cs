...
namespace NT.WEB.Controllers
{
    ...
    {
        private readonly OriginCountryWebService _service;

        public OriginCountryController(OriginCountryWebService service)
        {
        ...
        public async Task<IActionResult> Create(OriginCountry model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, OriginCountry model)
        {
